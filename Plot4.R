...
mypower_df$Voltage <- as.numeric(mypower_df$Voltage)
mypower_df$Global_reactive_power <- as.numeric(mypower_df$Global_reactive_power)

# plotting
dev.off()
par(mfrow= c(2,2))

plot(mypower_df$DateTime,mypower_df$Global_active_power,type="l", ylab ="Global Active Power", xlab = "")
...
plot(mypower_df$DateTime, mypower_df$Voltage, type="l", ylab ="Voltage", xlab = "datetime")
axis(side = 1,labels =  "Thu",at=mypower_df$DateTime[1])
axis(side = 1,labels =  "Fri",at=mypower_df$DateTime[1441])
axis(side = 1,labels =  "Sat",at=mypower_df$DateTime[2880])
...
plot(mypower_df$DateTime, mypower_df$Global_reactive_power,type="l", ylab ="Global_reactive_power", xlab = "datetime")
axis(side = 1,labels =  "Thu",at=mypower_df$DateTime[1])
axis(side = 1,labels =  "Fri",at=mypower_df$DateTime[1441])
axis(side = 1,labels =  "Sat",at=mypower_df$DateTime[2880])
